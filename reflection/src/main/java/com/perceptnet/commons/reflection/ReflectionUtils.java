...
public class ReflectionUtils {
    ...
    public static String getFieldName(Method method) {
        if (method.getName().startsWith("is")) {
            return StringUtils.decapitalize(StringUtils.getTail(method.getName(), "is"));
        } else if (method.getName().startsWith("get")) {
            return StringUtils.decapitalize(StringUtils.getTail(method.getName(), "get"));
        } else if (method.getName().startsWith("set")) {
            return StringUtils.decapitalize(StringUtils.getTail(method.getName(), "set"));
        } else {
    ...
    public static boolean isSetter(Method method) {
        ...
        Class<?> rt = method.getReturnType();
        if (!void.class.equals(rt) && !method.getDeclaringClass().isAssignableFrom(rt)) {
            return false;
        }
